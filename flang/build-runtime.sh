...
ROOT=$(realpath f18-llvm-project)

CFLAGS="-I${BUILD}/include -I${ROOT}/flang/include -I${ROOT}/llvm/include -I${BUILD}/tools/flang/runtime -DFLANG_LITTLE_ENDIAN -fPIC"
CXXFLAGS="${CFLAGS} -std=c++17 -Wno-c++11-narrowing"

cd ${ROOT}/flang/runtime
...
em++ ${CXXFLAGS} -c ${ROOT}/flang/lib/Decimal/decimal-to-binary.cpp -o decimal-to-binary.o
em++ ${CXXFLAGS} -c ${ROOT}/flang/lib/Decimal/binary-to-decimal.cpp -o binary-to-decimal.o
